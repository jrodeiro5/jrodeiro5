...
<picture>
  ...
  <img alt="GitHub activity: 3,300 contributions since April 2024, 88% in private repositories. Languages: Python 47%, TypeScript 19%, Go 12%." src="assets/stats-light.svg" width="100%" />
</picture>
<br>
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/stacks-dark.svg" />
  <img alt="Stack. Programming: Python, TypeScript, Go, SQL, FastAPI, Node.js, MCP, Claude. Marketing: GA4, Tag Manager, Piwik PRO, Adobe Analytics, Amplitude, PostHog. Data: BigQuery, DuckDB, Iceberg, MLflow, PostgreSQL, Supabase, Looker Studio, Power BI." src="assets/stacks-light.svg" width="100%" />
</picture>
<br>
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/about-dark.svg" />
  <img alt="About: AI &amp; Analytics Developer at cinfo. Before that, two years of web and app analytics for PULL&amp;BEAR (Inditex), where I built OmniZenit, the official debugger for Inditex's in-house analytics tool. Research lines: Agents and MCP, Knowledge systems, Local-first AI, Data platforms." src="assets/about-light.svg" width="100%" />
</picture>
<br>
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/milestones-dark.svg" />
  <img alt="Milestones: 2026, AI &amp; Analytics Developer at cinfo; 2025, Talk at MeasureCamp Madrid on MCP servers in data and analytics; 2024–26, Digital Data Analyst at Ayesa for PULL&amp;BEAR (Inditex); 2025–26, MSc in Big Data, Data Science and AI, Complutense University; 2023–24, Master in Web Analytics, KSchool; 2022–24, Data Analyst at Bysidecar." src="assets/milestones-light.svg" width="100%" />
</picture>
